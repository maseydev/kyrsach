...
<div style="display: flex; justify-content: center;" class="form-center">
	<form class="form-reg" action="/koshelev/login_system/registration.php" method="POST">
		<div >
		<div class="text-field text-field_floating-3">
  			<input class="text-field__input" type="text" id="name" name="Surname" placeholder="Введите фамилию">
  			<label class="text-field__label" for="name">Никнейм</label>
		</div>


		<div class="text-field text-field_floating-3">
  			<input class="text-field__input" type="text" id="name" name="Name" placeholder="Введите имя">
		...
		<div class="text-field text-field_floating-3">
  			<input class="text-field__input" type="email" id="name" name="Email" placeholder="Введите почту">
  			<label class="text-field__label" for="name">Почта</label>
		</div>
		<button type="submit" class="btn1">Зарегистрироваться</button>
				<p>
					<div style="font-weight: Bold; font-family: sans-serif;">У вас уже есть аккаунта? - <a href="/koshelev/login.php">Авторизируйтесь!</a></div>
                </p>
                <p>
